...
| `index.html` — Experiences | Link app **Passaggio** (tour) | `https://PASSAGGIO-URL-PLACEHOLDER` |
| `index.html` — Reputation | Link recensioni **Google** | `https://GOOGLE-REVIEWS-PLACEHOLDER` |
| `index.html` — Reputation | Link **TripAdvisor** | `https://TRIPADVISOR-PLACEHOLDER` |
